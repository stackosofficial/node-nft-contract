...
describe("Subscription", function () {
  ...
  //   await usdt
  //     .connect(partner)
  //     .approve(subscription.address, parseEther("500.0"));
  ...
  //   print(
  //     "gen 0 token 5 pending reward: ",
  //     await subscription.pendingReward(0, 5)
  //   );
  ...
  //   expect(oldPendingReward).to.be.equal(
  //     await stackToken.balanceOf(owner.address)
  //   );
  // });
  ...
  //   print(
  //     "gen 0 token 5 pending reward: ",
  //     await subscription.pendingReward(1, 1)
  //   );
  // });
